            ...
            <form onSubmit={handleTopUp} className="p-6 space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="number" required placeholder="e.g. 5000" value={topUpAmount} onChange={(e) => setTopUpAmount(e.target.value)} className="w-full h-11 pl-8 pr-4 bg-white border border-slate-200 rounded-xl text-[14px] font-bold text-slate-800 placeholder-slate-300 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 hover:border-slate-300 outline-none transition-all shadow-sm" />
                </div>
              </div>
      ...
      {showEndTripModal && (
        <div className="fixed inset-0 z-[100] bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden flex flex-col transform transition-all animate-in zoom-in-95 duration-200">
            ...
            <div className="p-6">
              <div className="mb-6 bg-red-50 p-4 rounded-lg border border-red-100 text-red-700 text-sm">
