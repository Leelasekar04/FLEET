...
const mockTaxReports = [
  { id: "TAX-PLAT-2026-Q2-US", period: "Q2 2026", jurisdiction: "United States (Federal)", amount: 45600.00, status: "filed" },
  { id: "TAX-PLAT-2026-Q2-CA", period: "Q2 2026", jurisdiction: "California (State)", amount: 12450.00, status: "pending" },
  { id: "TAX-PLAT-2026-Q1-US", period: "Q1 2026", jurisdiction: "United States (Federal)", amount: 41200.00, status: "filed" },
  { id: "TAX-PLAT-2026-Q1-CA", period: "Q1 2026", jurisdiction: "California (State)", amount: 11050.00, status: "filed" },
  { id: "TAX-PLAT-2025-YEA-UK", period: "Year End 2025", jurisdiction: "United Kingdom (HMRC)", amount: 89000.00, status: "filed" },
];

export default function SuperAdminTaxReportsPage() {
  ...
  const handleExport = () => {
    setToastMessage("Generating global tax documentation...");
    ...
    <div className="cmd-root p-6 max-w-[1600px] mx-auto">
      ...
      <div className="cmd-banner animate-fade-in">
        <div className="cmd-banner-left">
          <h1 className="cmd-banner-title">Global Tax Reports</h1>
          <p className="cmd-banner-sub">
            Manage platform tax liabilities, filings, and jurisdictional documentation.
          </p>
        </div>
