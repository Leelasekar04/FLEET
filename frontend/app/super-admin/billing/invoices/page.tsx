...
const mockInvoices = [
  { id: "INV-SUB-2026-001", company: "Kumar Transport Co.", plan: "Enterprise Pro", amount: 1490.00, issueDate: "2026-07-01", dueDate: "2026-07-15", status: "paid" },
  { id: "INV-SUB-2026-002", company: "Swift Delivery Logistics", plan: "Standard", amount: 350.00, issueDate: "2026-07-05", dueDate: "2026-07-20", status: "pending" },
  { id: "INV-SUB-2026-003", company: "Apex Freight Movers", plan: "Enterprise Custom", amount: 2999.00, issueDate: "2026-07-10", dueDate: "2026-07-25", status: "pending" },
  { id: "INV-SUB-2026-004", company: "City Cabs Inc.", plan: "Basic Fleet", amount: 125.50, issueDate: "2026-06-25", dueDate: "2026-07-10", status: "overdue" },
  { id: "INV-SUB-2026-005", company: "Global Shipping Solutions", plan: "Enterprise Pro", amount: 1490.00, issueDate: "2026-07-12", dueDate: "2026-07-27", status: "pending" },
];
...
export default function SuperAdminInvoicesPage() {
  ...
  const invoiceFields: EditField[] = [
    ...
    { name: 'plan', label: 'Subscription Plan', type: 'text', disabled: true },
  ...
  const filteredInvoices = invoices.filter(inv => {
    const matchesSearch = inv.company.toLowerCase().includes(searchTerm.toLowerCase()) || 
    ...
    <div className="cmd-root p-6 max-w-[1600px] mx-auto">
      ...
      <div className="cmd-banner animate-fade-in">
        <div className="cmd-banner-left">
          <h1 className="cmd-banner-title">Global Invoices</h1>
          <p className="cmd-banner-sub">
            Manage tenant subscription billing and oversee platform revenue collection.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 animate-fade-in stagger-1">
        ...
        <div className="cmd-stat-card group hover:border-emerald-200 transition-colors">
          ...
          <div className="cmd-stat-label">Platform Revenue (MTD)</div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-6 animate-fade-in stagger-2">
        <div className="relative w-full sm:w-80">
          ...
          <input 
            type="text"
            placeholder="Search invoices by ID or Company..." 
