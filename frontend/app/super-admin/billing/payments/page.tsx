...
const mockPayments = [
  { id: "TXN-SUB-2026-8901", company: "Kumar Transport Co.", plan: "Enterprise Pro", amount: 1490.00, method: "Bank Transfer", date: "2026-07-15", status: "completed" },
  { id: "TXN-SUB-2026-8902", company: "Swift Delivery Logistics", plan: "Standard", amount: 350.00, method: "Credit Card", date: "2026-07-14", status: "pending" },
  { id: "TXN-SUB-2026-8903", company: "Apex Freight Movers", plan: "Enterprise Custom", amount: 2999.00, method: "Wire Transfer", date: "2026-07-12", status: "completed" },
  { id: "TXN-SUB-2026-8904", company: "City Cabs Inc.", plan: "Basic Fleet", amount: 125.50, method: "Credit Card", date: "2026-07-10", status: "failed" },
  { id: "TXN-SUB-2026-8905", company: "Global Shipping Solutions", plan: "Enterprise Pro", amount: 1490.00, method: "Bank Transfer", date: "2026-07-09", status: "completed" },
];
    ...
    <div className="cmd-root p-6 max-w-[1600px] mx-auto">
      ...
      <div className="cmd-banner animate-fade-in">
        <div className="cmd-banner-left">
          <h1 className="cmd-banner-title">Global Payments</h1>
          <p className="cmd-banner-sub">
            Track incoming subscription payments, settlements, and failed transactions globally.
          </p>
        </div>
