  ...
  return (
    <div className="flex flex-col h-full min-h-0 bg-[#f1f5f9]">
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4 flex-shrink-0">
        <Link href="/driver/trips" className="inline-flex items-center gap-1.5 text-[12px] text-slate-400 hover:text-blue-600 transition-colors mb-3 font-medium">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 px-6 py-4 space-y-4">
        ...
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-8 text-center flex flex-col items-center justify-center min-h-[300px]">
          ...
          <p className="text-[13px] text-slate-500 max-w-sm">
            This is a placeholder page for the driver's trip details. The full trip management interface, map tracking, and expense breakdown will be built here.
          </p>
        </div>
      </div>
    </div>
